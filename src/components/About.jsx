                ...
                <div className="about-global">
                    ...
                    <div className="container">
                                        ...
                                        <div className="about-main-container-about">
                                            ...
                                            <div className="about-main-container-about-description">
                                                ...
                                                <p className="about-body-descripcion">
                                                    Mi nombre es <b>Jose Fabian Soltero Escobar</b>, soy estudiante de ingeniería en Biónica en la UPIITA-IPN, soy programador freelancer y autodidacta,
                                            mis intereses estan en la <b> ciencia de los datos</b> y el desarrollo de la <b>inteligencia artificial</b> , en mis tiempos libres me dedico  a la <b>edición de música digital</b>, pero tambien a la edicion de imagen y video</p>

                                                <p className="about-body-descripcion">
                                                    En esta pagina subire principalmente programas en MATLAB que podrian ser de utilidad, asi como proyectos que he desarollado como estudiante </p>
                        ...
                        <div className="about-container80">
                                ...
                                <div className="about-container40">
                                    ...
                                    <a href="https://es.wikipedia.org/wiki/Funci%C3%B3n_de_transferencia_relacionada_con_la_cabeza">
                                        ...
                                        <p>
                                            ...
                                            este pequeño hack al cerebro es lo que hace interesante este efectos,
                            ...
                            <p>
                                    Estas canciones que pondré a continuación dos de las ultimas canciones que subi a mi canal.
                                </p>
                            ...
                            <div class="about-muestra">
                                ...
                                <h3>
                                    Atencion: "¡Escuchar solo con audifonos!"
                                </h3>
                                ...
                                <div class="about-muestra-canciones">
                                    ...
                                    <div className="about-subtitulo">
                                        <img class="about-fas-fa-angle" src={angle} alt="Angle-icon" /><h2 class="about-h2" > Protesis Sustentable </h2>
                                    </div>
                                            ...
                                            <div className="about-data-general">
                                                ...
                                                <div className="about-data-der">
                                                    ...
                                                    <div className="data-dos">
                                                        <div>
                                                            <span>Jose Fabian Soltero Escobar</span>
                                                        </div>
                                                        <div>
            ...
            <div className="pie-pagina">
                <div className="footer-text">
                    <div className="footer-text-title">
                        <h3>La tecnica al servicio de la patria</h3>
                    </div>
                    <div className="footer-text-legend">
                        <p>Jose Fabian Soltero Escobar &copy; 2021</p>
                    </div>
                </div>
