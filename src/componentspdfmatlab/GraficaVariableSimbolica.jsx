...
import pdf from './pdfmatlab/GraficaVariableSimbolica.pdf';

function GraficaVariableSimbolica() {
    return (
        <Fragment>
                ...
                <div className="PDFMat-container">
                    ...
                    <div className="PDFMat-cuepo-caja">
                        ...
                        <div className="PDFMat-titlo">
                            ...
                            <h1>Gráfica usando variable simbólica</h1>
...
export default GraficaVariableSimbolica
