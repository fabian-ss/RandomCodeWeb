...
import pdf from './pdfmatlab/GraficasDeValorNumerico.pdf';

function GraficasDeValorNumerico() {
    return (
        <Fragment>
                ...
                <div className="PDFMat-container">
                    ...
                    <div className="PDFMat-cuepo-caja">
                        ...
                        <div className="PDFMat-titlo">
                            ...
                            <h1>Gráficas de valor númerico</h1>
...
export default GraficasDeValorNumerico
